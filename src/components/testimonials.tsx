        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              {/* Button #2 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-indigo-200 ${
                  category === 2
                    ? "relative bg-gradient-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:bg-gradient-to-b before:from-indigo-500/0 before:to-indigo-500/50 before:border-box before:mask-composite-exclude before:mask-linear-gradient(white_0_0)_padding-box,linear-gradient(white_0_0)"
                    : "opacity-65 transition-opacity hover:opacity-90"
                }`}
...
export function Testimonial({
  ...
  return (
    <article
      className={`relative rounded-2xl bg-gray-900/75 p-6 transition-opacity 
    border border-gray-700/50 shadow-lg shadow-black/30 backdrop-blur-md 
    hover:shadow-black/40 ${
      !testimonial.categories.includes(category) ? "opacity-30" : "opacity-100"
    }`}
    >
      <div className="flex flex-col gap-5">
        ...
        <p className="text-gray-300 text-lg italic before:content-['“'] after:content-['”']">
          {children}
        </p>
