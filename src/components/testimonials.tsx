      ...
      <div className='border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20'>
        ...
        <div className='mx-auto max-w-3xl pb-12 text-center'>
          ...
          <p className='text-lg text-indigo-200/65'>
            We leverage cutting-edge technology to connect job seekers with top
            employers, empowering professionals to build fulfilling careers and
            companies to hire the best talent—anytime, anywhere.
          </p>
        </div>
        ...
        <div>
          ...
          <div className='flex justify-center pb-12 max-md:hidden md:pb-16'>
            <div className='relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1'>
              {/* Button #1 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-300 ${
                  category === 1
                    ? 'before:border-box before:mask-composite-exclude before:mask-linear-gradient(white_0_0)_padding-box,linear-gradient(white_0_0) relative bg-gradient-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:bg-gradient-to-b before:from-indigo-500/0 before:to-indigo-500/50'
              ...
              {/* Button #2 */}
              <button
                className={`focus-visible:ring-3 flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-indigo-200 ${
                  category === 2
                    ? 'before:border-box before:mask-composite-exclude before:mask-linear-gradient(white_0_0)_padding-box,linear-gradient(white_0_0) relative bg-gradient-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:bg-gradient-to-b before:from-indigo-500/0 before:to-indigo-500/50'
                    : 'opacity-65 transition-opacity hover:opacity-90'
                }`}
...
export function Testimonial({
  ...
  return (
    <article
      className={`relative rounded-2xl border border-gray-700/50 bg-gray-900/75 p-6 shadow-lg shadow-black/30 backdrop-blur-md transition-opacity hover:shadow-black/40 ${
    ...
    >
      <div className='flex flex-col gap-5'>
        ...
        <p className="text-lg italic text-gray-300 before:content-['“'] after:content-['”']">
          {children}
        </p>
        <div className='flex items-center gap-4'>
          <Image
            className='inline-flex shrink-0 rounded-full border border-gray-700/50 shadow-md'
            src={testimonial.img}
            width={40}
            height={40}
