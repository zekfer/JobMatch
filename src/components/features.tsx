        ...
        <div className='border-t py-12 [border-image:linear-gradient(to_right,transparent,var(--color-slate-400)/25,transparent)1] md:py-20'>
          ...
          <div className='mx-auto max-w-3xl pb-4 text-center md:pb-12'>
            ...
            <p className='text-lg text-indigo-200/65'>
              Our advanced AI analyzes your skills, experience and perferences
              to suggest the best job opportunities tailored for you.
            </p>
          </div>
          ...
          <div className='mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3'>
            <article>
              ...
              <p className='text-indigo-200/65'>
                Track your progress across custom flows especially made for you.
                Find the right job , and also the good candidate.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className='text-indigo-200/65'>
                Receive customized job recommendations based on your skills,
                experience, and career interests. our mission is saving your
                time and effort in your job search.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className='text-indigo-200/65'>
                Easily find your ideal job using advanced filters like salary
                range, experience level, company size, industry, and location.
                This feature ensures that you only see the most relevant job
            ...
            <article>
              ...
              <p className='text-indigo-200/65'>
                Discover remote, part-time, and full-time and even training
                opportunities.
              </p>
            </article>
            <article>
              ...
              <p className='text-indigo-200/65'>
                Applying for jobs has never been easier! With a single click,
                submit applications, track your progress, and communicate with
                recruiters—all in one place. Stay organized and never miss an
                opportunity.
              </p>
            </article>
          </div>
